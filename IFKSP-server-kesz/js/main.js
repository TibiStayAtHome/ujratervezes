...
// H frissuljon, startGetUsers fuggveny itt es a vegen del nel is
...
// Delete this-t megnezni consolon h mi, majd beallitjuk, alul pedig "btn" element-t hivatkoyunk ra
// Szulo keresese a td tartalmat akarjuk torolni: megkeressuk td t utana ID t, amit torolni akarunk.

function delRow(btn) {
    let td = btn.parentElement.parentElement.parentElement.firstChild;
...
function newUserRow(row) {
    ...
    newBtn.innerHTML = '<i class="fa fa-user-plus" aria-hidden="true"></i>';
    let td = createAnyElement("td");
